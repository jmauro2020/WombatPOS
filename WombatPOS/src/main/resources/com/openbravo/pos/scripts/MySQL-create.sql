...
INSERT INTO SHIFT_BREAKS(ID, SHIFTID, BREAKID, STARTTIME, ENDTIME) VALUES ('0', '0', '0', '2016-12-02 00:00:00.003', '2016-12-02 00:00:00.004');
...
CREATE TABLE CSVEXPORT (
  ...
  TRANS_DATE DATETIME DEFAULT '2016-01-01 00:00:00' NOT NULL,
  REFERENCE VARCHAR(1024),
  CODE VARCHAR(1024),
